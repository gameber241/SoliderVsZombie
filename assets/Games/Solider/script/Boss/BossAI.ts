...
export class BossAI extends Component {
    ...
    update(dt: number) {
        ...
        if (this._state === BossState.MOVE) {
            this.playBossAnim(ESTATEBOSS.WALK, 0.03, true);
            ...
            this.playBossAnim(ESTATEBOSS.ATTACK, 0.03, true);
    ...
    startAttack() {
        ...
        }, this.bossUI.animationBoss.GetDuration() / 3 * 2)
        this.scheduleOnce(() => {
            console.log("Kết thúc tấn công");
            this.isAttack = false
